...
public class DataMainActivityReporte4ClienteReservasMonto extends AsyncTask<String, Void, String> {
    ...
    public DataMainActivityReporte4ClienteReservasMonto(Context context, ListView listaCliente, EditText cant_reservas) {
    ...
    protected String doInBackground(String... urls) {
        ...
        try {
            ...
            Statement st2 = con.createStatement();
                ...
                ResultSet rs1 = st1.executeQuery("SELECT r.idReserva, r.fechaEntrega, c.nombreCliente, c.codCliente, v.codigoVolquete, v.idvolquete FROM `reservas` r,`clientes` c , `volquetes` v where r.idcliente = c.idcliente and r.idvolquete =v.idvolquete and c.codCliente = '"+codigo_cliente+"'");
            ...
            ResultSet rs2 = st2.executeQuery("SELECT SUM(precio) as total FROM `reservas` r,`clientes` c , `volquetes` v where  r.idcliente = c.idcliente and r.idvolquete =v.idvolquete and c.codCliente = '"+codigo_cliente+"'");
